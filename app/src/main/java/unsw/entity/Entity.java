...
public abstract class Entity {
     ...
     * using a BooleanProperty here allows us to attach JavaFX ChangeListeners,
     * so that when this BooleanProperty switches to False,
     ...
     * <p>
     * A nice feature of ChangeListeners attached in another class is that the variable scope of the ChangeListener
     * matches the method it was declared in.
     * For example, when setting the ChangeListener for shouldExist for enemies from within the controller, we are able
     * to apply a teardown function which can remove the corresponding JavaFX node from its GridPane
     * which is within the scope of the method defining the ChangeListener.
     * This is why we don't have to track which JavaFX node corresponds to which backend entity explicitly!
     * (for example, in a Hashmap)
     */
    private final BooleanProperty shouldExist;

    private Image entityView;
    ...
    /**
     * Setter for entityView
     *
     * @param entityView //
     */
    public void setEntityView(Image entityView) {
        this.entityView = entityView;
    }

    /**
     * Getter for entityView
     *
     * @return //
     */
    public Image getEntityView() {
        return this.entityView;
    }

    /**
     * Method that load image
     *
     * @param pathname //
     * @return //
     */
     ...
     * this method is used in the starter code so the LoopManiaWorldController and LoopManiaWorldControllerLoader can
     ...
     * We can attach a ChangeListener to this so the x coordinates of the JavaFX node paired with this entity always
     * match.
     *
     ...
     * We can attach a ChangeListener to this so the y coordinate of the JavaFX node paired with this entity always
     * match.
     *
