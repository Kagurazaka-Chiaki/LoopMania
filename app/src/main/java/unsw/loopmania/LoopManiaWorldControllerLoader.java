...
public class LoopManiaWorldControllerLoader extends LoopManiaWorldLoader {
    ...
    private final Image pathTilesImage;
    private final Image heroCastleImage;

    @Override
    public Image onLoadImage(String pathname) {
        return new Image(pathname);
    }

    public LoopManiaWorldControllerLoader(Worlds world, Mode mode) throws FileNotFoundException {
        super(world, mode);
        entities = new ArrayList<>();
        characterImage = onLoadImage("images/human_new.png");
        pathTilesImage = onLoadImage("images/32x32GrassAndDirtPath.png");
        heroCastleImage = onLoadImage("images/heros_castle.png");
    }
     ...
     * x and y values we produce here are the coordinates of the top left of our sub-image, taken from the top-left of
     * the pathTilesImage
     */
    @Override
     ...
     * Items which potentially need to be removed should be spawned by controller, and have listener handles and
     * teardown functions added.
     *
     * @param entity backend entity
     ...
     * loaded entities.
     *
     * @return LoopManiaWorldController
     * @throws FileNotFoundException //
     */
    public LoopManiaWorldController loadController() throws FileNotFoundException {
        return new LoopManiaWorldController(super.load(), entities);
    }
